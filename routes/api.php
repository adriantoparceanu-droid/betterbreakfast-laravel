...
use App\Http\Controllers\Api\ResetPlanController;
...
Route::middleware(['auth', 'single.device'])->group(function () {
    ...
    Route::post('/user/reset-plan', [ResetPlanController::class, 'store']);
    Route::post('/analytics',       [AnalyticsController::class, 'store'])->withoutMiddleware(['auth', 'single.device']);
});
